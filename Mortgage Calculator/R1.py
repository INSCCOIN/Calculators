...
land_tax_rate_label = tk.Label(root, text="Land Tax Rate (%):")
land_tax_rate_label.pack()

land_tax_rate_entry = tk.Entry(root)
land_tax_rate_entry.pack()
