...
class MortgageCalculator:
    """A class to encapsulate the functionality of a mortgage calculator."""
    
    def __init__(self, master):
        self.master = master
        self.master.title("Mortgage Calculator")
        self.master.geometry("400x600")  # Set initial size of the window
    ...
    def create_widgets(self):
        ...
        interest_only_checkbox.grid(row=3, columnspan=2, sticky='w')
        ...
        self.refinance_checkbox.grid(row=4, columnspan=2, sticky='w')
        ...
        self.mortgage_result_label.grid(row=6, columnspan=2, pady=10)
    ...
    def create_refinance_section(self):
        ...
        self.refinance_frame = tk.LabelFrame(self.master, text="Refinance Options", padx=10, pady=10)
    ...
    def calculate_mortgage(self):
        """Calculate the mortgage and create an amortization schedule."""
        ...
        property_tax = float(self.property_tax_entry.get()) / 12  # Convert annual to monthly
        home_insurance = float(self.home_insurance_entry.get()) / 12  # Convert annual to monthly
        ...
        # New functionality to display total cost and interest
    ...
    def compute_payments(self, principal, interest_rate, num_years, interest_only):
    ...
    def plot_amortization_schedule(self, amortization_schedule):
        ...
        # Create a twin axis to plot the interest and principal payments
        ax2 = ax1.twinx()
        color = 'tab:red'
        ...
        # Adding a legend with both axes
